                ...
                <div className="relative z-10 flex flex-col justify-between" style={{ minHeight: 440, padding: "60px 52px 36px 52px" }}>
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12 flex-1">
                        ...
                        <nav className="flex flex-col items-start gap-[13px] pt-2">
                            {["Docs", "Contact Us", "Blog", "GitHub", "Careers", "Terms & Conditions", "Privacy Policy"].map(link => (
                                <a
                                    key={link}
                                    href={link === "Docs" ? (process.env.NEXT_PUBLIC_DOCS_URL || "http://localhost:3001/docs/getting-started") : link === "GitHub" ? "https://github.com/sarthakNITT/solana-middleware-protocol" : "#"}
                    ...
                    <div className="flex flex-col md:flex-row items-end justify-between gap-4 mt-auto pt-10">
                        <div className="flex items-center gap-2.5">
                            <a href="https://x.com/SendraTx" className="w-[30px] h-[30px] rounded-full flex items-center justify-center text-white/60 hover:text-white transition-colors duration-200" style={{ background: "rgba(255,255,255,0.1)" }}>
                            ...
                            <a href="https://github.com/sarthakNITT/solana-middleware-protocol" className="w-[30px] h-[30px] rounded-full flex items-center justify-center text-white/60 hover:text-white transition-colors duration-200" style={{ background: "rgba(255,255,255,0.1)" }}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
